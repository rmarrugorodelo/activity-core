...
import com.rmarrugo.test.infrastructure.apirest.activity.dto.ActivityRequest;
...
public class ActivityWriterController {
    ...
    @PostMapping
    public void create(@Valid @RequestBody ActivityRequest request) {
        activityWriter.create(request.toDomain(), request.getEmployeeId());
    }

    @ResponseStatus(HttpStatus.OK)
    @PutMapping("{id}")
    public void update(@PathVariable Long id, @Valid @RequestBody ActivityRequest request) {
